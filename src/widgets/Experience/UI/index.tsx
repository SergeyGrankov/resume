  ...
  return (
    <div>
      ...
      <div className={styles.info}>
        <motion.div className={styles.title} {...getMotionProps(0.4)}>
        ...
        <motion.span className={styles.title} {...getMotionProps(0.6)}>
          Post:
        </motion.span>
        <motion.span className={styles.text} {...getMotionProps(0.6)}>
          {' '}
          Frontend-developer
        </motion.span>

        <motion.div className={styles.title} {...getMotionProps(0.8)}>
          What did I do:
        </motion.div>
        ...
        <motion.div className={styles.text} {...getMotionProps(1.2)}>
        ...
        <motion.div className={styles.title} {...getMotionProps(1.4)}>
          2. Search Project:
        </motion.div>
        <motion.div className={styles.text} {...getMotionProps(1.4)}>
          ◉&nbsp;
          <Link
            href="https://domclick.ru/search?category=living&deal_type=sale&offer_type=complex&from=topline2020"
            underline="hover"
        ...
        <motion.div className={styles.text} {...getMotionProps(1.6)}>
          ◉&nbsp;
          <Link
